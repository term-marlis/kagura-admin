...
from flaskr.form import ProjectBasicForm, ProjectItemForm, ProjectDetailForm, ProjectReportForm, ProjectFaqForm, \
...
def project_form_to_api_project(basic_form: ProjectBasicForm) -> sw.Project:
    ...
    project.is_approval = basic_form.is_approval.data
    return project
